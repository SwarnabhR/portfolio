...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of S. Roy (oxy) — ML engineering, quantitative research, deep learning, algorithmic trading, and neural systems across financial markets.',
  keywords: [
